...
export const ArtifactPanel: React.FC<ArtifactPanelProps> = ({ isOpen, onClose, code, language }) => {
  ...
  return (
    <div className="w-1/2 min-w-[450px] border-l border-gray-200 dark:border-[#27272A] bg-white dark:bg-[#101011] flex flex-col h-full animate-in slide-in-from-right duration-300 shadow-xl z-20">
      {/* Header */}
      <div className="h-16 border-b border-gray-200 dark:border-[#27272A] flex items-center justify-between px-5 bg-white dark:bg-[#101011] flex-shrink-0">
        ...
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-gray-100 dark:bg-[#18181B] border border-gray-200 dark:border-[#27272A] p-1 rounded-full flex gap-1">
            ...
            className={`flex items-center gap-2 px-4 py-1 rounded-full text-[13px] font-medium transition-all duration-200 ${
              activeTab === 'code' 
