    ...
    <div className="w-full mx-auto pb-4">
      ...
      <div className={`relative bg-white dark:bg-[#2F2F32] rounded-[26px] transition-all duration-200 shadow-lg border border-gray-200 dark:border-transparent flex flex-col mx-2 md:mx-0 ${input.length > 50 ? 'rounded-[20px]' : ''}`}>
        ...
        <textarea
          ...
          className="w-full flex-1 bg-transparent border-none outline-none resize-none px-4 md:px-5 pt-4 md:pt-5 pb-2 text-gray-800 dark:text-gray-200 placeholder-gray-400 dark:placeholder-gray-500 text-[15px] leading-relaxed scrollbar-hide min-h-[50px] md:min-h-[60px]"
          rows={1}
        />

        {/* Toolbar */}
        <div className="px-2 md:px-3 pb-3 pt-2 flex items-center justify-between mt-auto">
          <div className="flex items-center gap-1 md:gap-2 relative">
            ...
            <div className="relative group">
              <button 
                ...
                className={`flex items-center gap-1.5 md:gap-2 px-2 md:px-3 py-1.5 rounded-full text-[12px] md:text-[13px] font-medium transition-all ${
                  isThinkingEnabled 
      ...
      {suggestions && suggestions.length > 0 && (
        <div className="w-full overflow-x-auto scrollbar-hide mt-4 md:mt-6 px-2 md:px-0">
          <div className="flex flex-nowrap md:flex-wrap md:justify-center gap-2 min-w-max md:min-w-0 px-2 pb-2">
            ...
            <button className="flex items-center gap-2 px-3.5 py-2 bg-white dark:bg-[#1f1f23] hover:bg-gray-50 dark:hover:bg-[#2a2a2e] border border-gray-200 dark:border-[#2e2e32] rounded-full text-[13px] font-medium text-gray-600 dark:text-gray-300 transition-all shadow-sm whitespace-nowrap">
               More
            </button>
          </div>
        </div>
